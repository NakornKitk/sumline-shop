...
function ProductList() {
  ...
  return (
    <div className="grid justify-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-[20px] mt-[40px] pb-10 bg-white px-[20px] md:px-[50px] 2xl:px-[175px]">
